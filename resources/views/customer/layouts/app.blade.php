...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/customer-theme/vendor.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/customer-theme/style.css') }}">
...
<body>
    ...
    <header>
        <div class="container-fluid">
            <div class="d-flex justify-content-between ">
                ...
                <div class="main-logo">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('assets/img/logo/logo-wfp.jpg') }}" alt="logo" class="img-logo">
                    </a>
                </div>
                <ul class="d-flex align-items-center list-unstyled m-0">
                    <li>
                        <a href="{{ route('profile.index') }}" class="rounded-circle bg-light p-2 mx-1">
    ...
    <script src="{{ asset('assets/js/customer-theme/jquery-1.11.0.min.js') }}"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous">
    </script>
    <script src="{{ asset('assets/js/customer-theme/plugins.js') }}"></script>
    <script src="{{ asset('assets/js/customer-theme/script.js') }}"></script>
